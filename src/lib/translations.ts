...
export const translations = {
  en: {
    ...
    agent: {
      ...
      subDesc: "Our AI scans your recorded expenses to find recurring leaks (Netflix, Gym, etc.).",
      subButton: "Scan Recurring Expenses",
      scanning: "Scanning Patterns...",
      noSubs: "No recurring subscriptions found yet.",
      noExpensesLastMonth: "No expenses recorded for last month yet.",
      foundSubs: "Subscriptions Found",
      totalDrain: "Annual Drain",
      howItWorks: "How it works? AI matches patterns and keywords in your expenses to detect silent leaks.",
      errors: {
