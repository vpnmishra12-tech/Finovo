...
export default function Home() {
  ...
  const GridCard = ({ icon: Icon, label, color, onClick }: { icon: any, label: string, color: string, onClick: () => void }) => (
    <Card 
      className="border-none shadow-sm active:scale-95 transition-all cursor-pointer rounded-[1rem] bg-white h-26 flex items-center overflow-hidden"
      onClick={onClick}
    >
              ...
              <div className="flex-1 flex flex-col animate-in fade-in duration-300 overflow-hidden">
                ...
                <div className="flex-1 flex flex-col overflow-hidden">
                  <div className="flex-1 overflow-y-auto no-scrollbar px-5 space-y-4 pb-2">
                    ...
                    <div className="mb-2">
                      <Alert className="py-3.5 px-3 rounded-[0.8rem] border bg-[#FFF1F1] text-[#D32F2F] border-[#FFE4E4] flex items-center gap-2 shrink-0">
