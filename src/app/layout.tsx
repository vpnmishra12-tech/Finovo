...
const APP_ICON_URL = 'https://images.unsplash.com/photo-1620714223084-8fcacc6dfd8d?w=512&h=512&fit=crop&q=80&v=walletv11';
  ...
  return (
    <html lang="en" className="dark">
      <head>
        ...
        {/* Definitive Wallet Icon v11 - Neon Edition */}
